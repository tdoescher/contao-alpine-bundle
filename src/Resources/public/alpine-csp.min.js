(() => {
    ...
    var ft = new MutationObserver(ht), dt = !1;

    function de() {
        ft.observe(document, { subtree: !0, childList: !0, attributes: !0, attributeOldValue: !0 }), dt = !0;
    }
    ...
    function Ln(e) {
        let [ t, r ] = gt(e), n = { interceptor: Me, ...t };
        return re(e, r), n;
    }
...
` : '' }`, t), setTimeout(() => {
    ...
    function jn(e, t) {
        let r = {};
        G(r, e);
        let n = [ r, ...k(e) ], i = typeof t == 'function' ? yt(n, t) : Bn(n, t, e);
    ...
    function me(e, t, r) {
        if (t = Array.from(t), e._x_virtualDirectives) {
            let o = Object.entries(e._x_virtualDirectives).map(([ a, c ]) => ({ name: a, value: c })), s = vt(o);
    ...
    function Hn(e, t) {
        let r = J.indexOf(e.type) === -1 ? wt : e.type, n = J.indexOf(t.type) === -1 ? wt : t.type;
    ...
    function Xn(e, t, r) {
        ...
        let s = !t.includes('opacity') && !t.includes('scale'), a = s || t.includes('opacity'),
            c = s || t.includes('scale'), l = a ? 0 : 1, u = c ? ge(t, 'scale', 95) / 100 : 1,
            p = ge(t, 'delay', 0) / 1e3, h = ge(t, 'origin', 'center'), w = 'opacity, transform',
            z = ge(t, 'duration', 150) / 1e3, ve = ge(t, 'duration', 75) / 1e3, f = 'cubic-bezier(0.4, 0.0, 0.2, 1)';
    ...
    function Or(e, t, r = {}) {
        e._x_transition || (e._x_transition = {
            ...
            in(n = () => {
                ...
                Be(e, t, { during: this.enter.during, start: this.enter.start, end: this.enter.end }, n, i);
            },
            out(n = () => {
            }, i = () => {
            }) {
                Be(e, t, { during: this.leave.during, start: this.leave.start, end: this.leave.end }, n, i);
            },
        });
    }
    ...
    function Be(e, t, { during: r, start: n, end: i } = {}, o = () => {
    }, s = () => {
    }) {
    ...
    function ei(e, t) {
        if (Ct(e)) e.attributes.value === void 0 && (e.value = t), window.fromModel && (typeof t == 'boolean' ? e.checked = ye(e.value) === t : e.checked = Dr(e.value, t)); else if (Ke(e)) Number.isInteger(t) ? e.value = t : !Array.isArray(t) && typeof t != 'boolean' && ![ null, void 0 ].includes(t) ? e.value = String(t) : Array.isArray(t) ? e.checked = t.some(r => Dr(r, e.value)) : e.checked = !!t; else if (e.tagName === 'SELECT') si(e, t); else {
            if (e.value === t) return;
            e.value = t === void 0 ? '' : t;
        }
    }
    ...
    function qe({ get: e, set: t }, { get: r, set: n }) {
        let i = !0, o, s, a = N(() => {
            let c = e(), l = r();
            if (i) n(Tt(c)), i = !1; else {
    ...
    function Rt(e, t, r) {
        let n = [];
        for (; n.length;) n.pop()();
        let i = Object.entries(t).map(([ s, a ]) => ({ name: s, value: a })), o = vt(i);
    ...
    function di(e, t, r) {
        return (n = () => {
            ...
            let s = P([ i, ...r ]), a = t.split('.').reduce((c, l) => (c[l] === void 0 && pi(e, t), c[l]), s);
            ie(n, a, s, o);
        };
    }
...
`, e);
    ...
    var Yr = Object.freeze({}), Us = Object.freeze([]);
    var hi = Object.prototype.hasOwnProperty, be = (e, t) => hi.call(e, t), V = Array.isArray,
        ae = e => Xr(e) === '[object Map]';
    var _i = e => typeof e == 'string', Ue = e => typeof e == 'symbol', we = e => e !== null && typeof e == 'object';
    var gi = Object.prototype.toString, Xr = e => gi.call(e), Nt = e => Xr(e).slice(8, -1);
    var We = e => _i(e) && e !== 'NaN' && e[0] !== '-' && '' + parseInt(e, 10) === e;
    var Ge = e => {
            let t = Object.create(null);
            return r => t[r] || (t[r] = e(r));
        }, xi = /-(\w)/g, Ws = Ge(e => e.replace(xi, (t, r) => r ? r.toUpperCase() : '')), yi = /\B([A-Z])/g,
        Gs = Ge(e => e.replace(yi, '-$1').toLowerCase()), kt = Ge(e => e.charAt(0).toUpperCase() + e.slice(1)),
        Js = Ge(e => e ? `on${ kt(e) }` : ''), Dt = (e, t) => e !== t && (e === e || t === t);
    var Pt = new WeakMap, Ee = [], j, ee = Symbol('iterate'), It = Symbol('Map key iterate');
    ...
    var Ai = Mt('__proto__,__v_isRef,__isVue'),
        cn = new Set(Object.getOwnPropertyNames(Symbol).map(e => Symbol[e]).filter(Ue)), Oi = ln();
    var Ci = ln(!0);
    var Zr = Ti();
    ...
    function Mi(e = !1) {
        return function (r, n, i, o) {
            ...
            let a = V(r) && We(n) ? Number(n) < r.length : be(r, n), c = Reflect.set(r, n, i, o);
            return r === _(o) && (a ? Dt(i, s) && U(r, 'set', n, i, s) : U(r, 'add', n, i)), c;
        };
    }

    function Ni(e, t) {
        let r = be(e, t), n = e[t], i = Reflect.deleteProperty(e, t);
    ...
    var Pi = { get: Oi, set: Ri, deleteProperty: Ni, has: ki, ownKeys: Di }, Ii = {
        get: Ci, set(e, t) {
    ...
    var jt = e => we(e) ? tt(e) : e, Ft = e => we(e) ? mn(e) : e, Bt = e => e, et = e => Reflect.getPrototypeOf(e);

    function Je(e, t, r = !1, n = !1) {
        e = e.__v_raw;
        let i = _(e), o = _(t);
        t !== o && !r && M(i, 'get', t), !r && M(i, 'get', o);
        let { has: s } = et(i), a = n ? Bt : r ? Ft : jt;
    ...
    function en(e, t) {
        t = _(t);
        let r = _(this), { has: n, get: i } = et(r), o = n.call(r, e);
    ...
    function tn(e) {
        let t = _(this), { has: r, get: n } = et(t), i = r.call(t, e);
    ...
    function rn() {
        let e = _(this), t = e.size !== 0, r = ae(e) ? new Map(e) : new Set(e), n = e.clear();
        return t && U(e, 'clear', void 0, void 0, r), n;
    }

    function Ze(e, t) {
        return function (n, i) {
            let o = this, s = o.__v_raw, a = _(s), c = t ? Bt : e ? Ft : jt;
    ...
    function Qe(e, t, r) {
        return function (...n) {
            let i = this.__v_raw, o = _(i), s = ae(o), a = e === 'entries' || e === Symbol.iterator && s,
                c = e === 'keys' && s, l = i[e](...n), u = r ? Bt : t ? Ft : jt;
    ...
    function $i() {
        let e = {
            get(o) {
                ...
                return Xe(this);
            }, has: Ye, add: Qr, set: en, delete: tn, clear: rn, forEach: Ze(!1, !1),
        }, t = {
            get(o) {
                return Je(this, o, !1, !0);
            }, get size() {
                return Xe(this);
            }, has: Ye, add: Qr, set: en, delete: tn, clear: rn, forEach: Ze(!1, !0),
        }, r = {
            get(o) {
                return Je(this, o, !0);
            }, get size() {
            ...
            }, add: q('add'), set: q('set'), delete: q('delete'), clear: q('clear'), forEach: Ze(!0, !1),
        }, n = {
            get(o) {
                ...
                return Ye.call(this, o, !0);
            }, add: q('add'), set: q('set'), delete: q('delete'), clear: q('clear'), forEach: Ze(!0, !0),
        };
    ...
    var dn = new WeakMap, Hi = new WeakMap, pn = new WeakMap, Vi = new WeakMap;
    ...
    y('id', (e, { cleanup: t }) => (r, n = null) => {
        let i = `${ r }${ n ? `-${ n }` : '' }`;
        return Gi(e, i, t, () => {
            let o = _n(e, r), s = o ? o._x_ids[r] : Kt(r);
            return n ? `${ r }-${ s }-${ n }` : `${ r }-${ s }`;
        });
    });
    H((e, t) => {
    ...
    d('modelable', (e, { expression: t }, { effect: r, evaluateLater: n, cleanup: i }) => {
        ...
        c(l), queueMicrotask(() => {
            ...
            let u = e._x_model.get, p = e._x_model.set, h = qe({
                get() {
                    return u();
                }, set(w) {
                    p(w);
    ...
    d('teleport', (e, { modifiers: t, expression: r }, { cleanup: n }) => {
        ...
        let i = yn(r), o = e.content.cloneNode(!0).firstElementChild;
    ...
    bn.inline = (e, { modifiers: t }, { cleanup: r }) => {
    ...
    d('model', (e, { modifiers: t, expression: r }, { effect: n, cleanup: i }) => {
        ...
        if (t.includes('fill') && ([ void 0, null, '' ].includes(c()) || Ke(e) && Array.isArray(c()) || e.tagName.toLowerCase() === 'select' && e.multiple) && l(Ht(e, t, { target: e }, c())), e._x_removeModelListeners || (e._x_removeModelListeners = {}), e._x_removeModelListeners.default = p, i(() => e._x_removeModelListeners.default()), e.form) {
            let h = le(e.form, 'reset', [], w => {
                se(() => e._x_model && e._x_model.set(Ht(e, t, { target: e }, c())));
            });
            i(() => h());
        }
        e._x_model = {
    ...
    oe(Ie(':', $e(C('bind:'))));
    var Sn = (e, { value: t, modifiers: r, expression: n, original: i }, { effect: o, cleanup: s }) => {
        if (!t) {
            let c = {};
            qr(c), x(e, n)(u => {
                Rt(e, u, i);
    ...
    d('for', (e, { expression: t }, { effect: r, cleanup: n }) => {
        let i = so(t), o = x(e, i.items), s = x(e, e._x_keyExpression || 'index');
    ...
    function oo(e, t, r, n) {
        ...
        r(s => {
            ...
            for (let f = 0; f < u.length; f++) {
                ...
                if (b === -1) c.splice(f, 0, g), p.push([ ve, f ]); else if (b !== f) {
            ...
            for (let f = 0; f < p.length; f++) {
                ...
                let O = l[b], te = u[b], ue = document.importNode(o.content, !0).firstElementChild, Ut = T(O);
    ...
    On.inline = (e, { expression: t }, { cleanup: r }) => {
        let n = X(e);
    ...
    K.setEvaluator(Jr);
    K.setReactivityEngine({ reactive: tt, effect: nn, release: on, raw: _ });
    var qt = K;
    window.Alpine = qt;
    queueMicrotask(() => {
        qt.start();
