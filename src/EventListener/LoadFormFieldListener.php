...
class LoadFormFieldListener
{
    public function __invoke(Widget $widget, string $formId, array $formData, Form $form): Widget
    {
        ...
        if (!in_array($widget->type, [ 'explanation', 'fieldsetStart', 'date', 'email', 'number', 'tel', 'url', 'text', 'textdigit', 'textcustom', 'password', 'passwordcustom', 'textarea', 'textareacustom', 'select', 'radio', 'checkbox', 'upload', 'range', 'hidden', 'hiddencustom', 'submit' ])) {
            return $widget;
        }
        ...
        if (in_array($widget->type, [ 'explanation', 'fieldsetStart', 'date', 'email', 'number', 'tel', 'url', 'text', 'textdigit', 'textcustom', 'password', 'passwordcustom', 'textarea', 'textareacustom', 'select', 'radio', 'checkbox', 'upload', 'range', 'submit' ])) {
        ...
        if (in_array($widget->type, [ 'date', 'email', 'number', 'tel', 'url', 'text', 'textdigit', 'textcustom', 'password', 'passwordcustom', 'textarea', 'textareacustom', 'select', 'radio', 'checkbox', 'upload', 'range', 'hidden', 'hiddencustom' ])) {
        ...
        // Field @input
        if (in_array($widget->type, [ 'date', 'email', 'number', 'tel', 'url', 'text', 'textdigit', 'textcustom', 'password', 'passwordcustom', 'textarea', 'textareacustom' ])) {
            if ($widget->xOnInput) $widget->addAttribute($prefixOn . 'input', $widget->xOnInput);
        }

        // Field/Button @focus, @blur, :class and :disabled
        if (in_array($widget->type, [ 'date', 'email', 'number', 'tel', 'url', 'text', 'textdigit', 'textcustom', 'password', 'passwordcustom', 'textarea', 'textareacustom', 'select', 'radio', 'checkbox', 'upload', 'range', 'submit' ])) {
